...
def calc_align(ori_seq1, ori_seq2, matrix):
    ...
    for i in gap_open:
        for j in gap_ext:
            ...
            alignments = pairwise2.align.localds(ori_seq1, ori_seq2, matrix, i, j)
...
def main():
    ...
    seq2007_M2 = SeqIO.read("Brisbane2007_M2.txt", "fasta")
    ...
    for i in range(2):
        ...
        print "Sequences: Brisbane2007 & Brisbane2007_M2"
        calc_align(seq2007.seq, seq2007_M2.seq, matrix[i])
